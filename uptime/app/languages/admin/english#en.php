...
return [
    ...
    'admin_plans.plan.monitors_limit' => 'Uptime monitors limit',
    'admin_plans.plan.monitors_check_intervals' => 'Uptime monitors check intervals',
    'admin_plans.plan.monitors_ping_servers' => 'Uptime monitors ping servers',
    'admin_plans.plan.heartbeats_limit' => 'Heartbeats limit',
    'admin_plans.plan.domain_names_limit' => 'Domain names limit',
    'admin_plans.plan.dns_monitors_limit' => 'DNS monitors limit',
    'admin_plans.plan.dns_monitors_check_intervals' => 'DNS monitors check intervals',
    'admin_plans.plan.server_monitors_limit' => 'Server monitors limit',
    'admin_plans.plan.server_monitors_check_intervals' => 'Server monitors check intervals',
    'admin_plans.plan.status_pages_limit' => 'Status pages limit',
    ...
    'admin_plans.plan.logs_retention' => 'Monitors, heartbeats, DNS monitors, server monitors logs retention',
    'admin_plans.plan.logs_retention_help' => 'How many days will the history logs be kept in the database.',
    'admin_plans.plan.statistics_retention' => 'Status pages statistics retention',
    'admin_plans.plan.statistics_retention_help' => 'How many days will the status pages statistics be kept in the database.',
    ...
    'admin_plans.plan.password_protection_is_enabled_help' => 'Enable access to password protect status pages.',
    'admin_plans.plan.analytics_is_enabled' => 'Analytics',
    'admin_plans.plan.analytics_is_enabled_help' => 'Enable analytics for status pages.',
    'admin_plans.plan.custom_pwa_is_enabled' => 'Custom vcard page PWA',
    'admin_plans.plan.custom_pwa_is_enabled_help' => 'The user vcard pages will be able to have their own customizable PWA app.',
    'admin_plans.plan.qr_is_enabled' => 'QR code builder',
    'admin_plans.plan.qr_is_enabled_help' => 'Enable QR code builder for status pages.',
    'admin_plans.plan.removable_branding_is_enabled' => 'Removable branding',
    'admin_plans.plan.removable_branding_is_enabled_help' => 'Enable ability to remove the branding from the status pages.',
    'admin_plans.plan.custom_url_is_enabled' => 'Custom back-half URL',
    'admin_plans.plan.custom_url_is_enabled_help' => 'Enable ability to choose a custom URL when creating a status page.',
    'admin_plans.plan.search_engine_block_is_enabled' => 'Block search engine indexing',
    'admin_plans.plan.search_engine_block_is_enabled_help' => 'Enable ability to block search engines from indexing status pages.',
    'admin_plans.plan.custom_css_is_enabled' => 'Custom CSS',
    'admin_plans.plan.custom_css_is_enabled_help' => 'Enable ability to add custom css for each status page. Be aware to only allow trusted people to use this feature.',
    'admin_plans.plan.custom_js_is_enabled' => 'Custom JS',
    'admin_plans.plan.custom_js_is_enabled_help' => 'Enable ability to add custom js for each status page. Be aware to only allow trusted people to use this feature.',
    'admin_plans.plan.email_reports_is_enabled' => 'Email reports',
    'admin_plans.plan.email_reports_is_enabled_help' => 'Enable ability for the user to get analytics email reports for each monitor.',
    ...
    'admin_settings.theme.font_family_help' => 'Write the CSS font family name (ex: Times New Roman). Leave empty for default.',
    ...
    'admin_settings.custom.head_js_status_page' => 'Status pages head Javascript',
    'admin_settings.custom.head_css_status_page' => 'Status pages custom CSS',
    'admin_settings.custom.body_content_status_page' => 'Status pages body content',
    ...
    'admin_settings.cron.monitors' => 'Uptime monitors tracking cron job',
    'admin_settings.cron.heartbeats' => 'Heartbeats tracking cron job',
    'admin_settings.cron.domain_names' => 'Domain names tracking cron job',
    'admin_settings.cron.dns_monitors' => 'DNS monitors tracking cron job',
    'admin_settings.cron.monitors_email_reports' => 'Uptime monitors email reports cron job',
    'admin_settings.cron.heartbeats_email_reports' => 'Heartbeats email reports cron job',
    ...
    'admin_settings.ads.header_status_pages' => 'Status page header',
    'admin_settings.ads.footer_status_pages' => 'Status page footer',

    'admin_settings.status_pages.tab' => 'Status pages',
    'admin_settings.status_pages.status_pages_is_enabled' => 'Status pages system is enabled',
    'admin_settings.status_pages.example_url' => 'Example status page URL',
    'admin_settings.status_pages.example_url_help' => 'Display example status page button on the homepage. Leave empty to disable.',
    'admin_settings.status_pages.random_url_length' => 'Random URL length',
    'admin_settings.status_pages.random_url_length_help' => 'How many characters should be used to generate a random URL slug when a custom one is not given.',
    'admin_settings.status_pages.branding' => 'Branding',
    'admin_settings.status_pages.branding_help' => 'This branding is used by default in the status pages footer. HTML can be used in this field.',
    'admin_settings.status_pages.branding_help2' => 'You can use the following dynamic variables: <code>{{WEBSITE_TITLE}}</code>, <code>{{URL}}</code>, <code>{{AFFILIATE_URL_TAG}}</code>.',
    'admin_settings.status_pages.domains_is_enabled' => 'Enable the Custom Domains system',
    'admin_settings.status_pages.domains_is_enabled_help' => 'Enabling this will give your users the ability to add and use custom domains.',
    'admin_settings.status_pages.additional_domains_is_enabled' => 'Enable the Additional Custom Domains system',
    'admin_settings.status_pages.additional_domains_is_enabled_help' => 'Enabling this will give you the ability to add global domains via the admin panel that your users can use as additional domains.',
    'admin_settings.status_pages.main_domain_is_enabled' => 'Enable the usage of the main domain',
    'admin_settings.status_pages.main_domain_is_enabled_help' => 'Enabling this will give your users the ability to use the main domain to create status pages. This function will only work if the Custom Domains system is enabled and there is at least one global custom domain available. Even if this option is disabled, admins will still be allowed to use the main domain.',
    'admin_settings.status_pages.domains_custom_main_ip' => 'IP of your server',
    'admin_settings.status_pages.domains_custom_main_ip_help' => 'The IP that will be displayed when adding a custom domain. Leave empty to show the default detected server IP.',
    'admin_settings.status_pages.logo_size_limit' => 'Status pages logo size limit',
    'admin_settings.status_pages.favicon_size_limit' => 'Status pages favicon size limit',
    'admin_settings.status_pages.opengraph_size_limit' => 'Status pages opengraph size limit',
    'admin_settings.status_pages.pwa_icon_size_limit' => 'Status pages PWA icon size limit',
    'admin_settings.status_pages.blacklisted_domains' => 'Blacklisted domains',
    'admin_settings.status_pages.blacklisted_domains_help' => 'People will not be able to submit any URL domain that is included in this list. Comma separated values of domains.',
    'admin_settings.status_pages.blacklisted_keywords' => 'Blacklisted keywords',
    'admin_settings.status_pages.blacklisted_keywords_help' => 'People will not be able to use any url alias that is included in this list. Comma separated values of keywords.',

    'admin_settings.monitors_heartbeats.tab' => 'Monitoring system',
    'admin_settings.monitors_heartbeats.monitors_is_enabled' => 'Uptime monitors system is enabled',
    'admin_settings.monitors_heartbeats.dns_monitors_is_enabled' => 'DNS monitors system is enabled',
    'admin_settings.monitors_heartbeats.server_monitors_is_enabled' => 'Server monitors system is enabled',
    'admin_settings.monitors_heartbeats.heartbeats_is_enabled' => 'Heartbeats system is enabled',
    'admin_settings.monitors_heartbeats.domain_names_is_enabled' => 'Domain names system is enabled',
    'admin_settings.monitors_heartbeats.projects_is_enabled' => 'Enable the Projects system',
    'admin_settings.monitors_heartbeats.projects_is_enabled_help' => 'Enabling this will give your users the ability to sort & tag their resources.',
    'admin_settings.monitors_heartbeats.email_reports_is_enabled' => 'Email reports system for monitors & heartbeats',
    'admin_settings.monitors_heartbeats.email_reports_is_enabled_weekly' => 'Weekly',
    'admin_settings.monitors_heartbeats.email_reports_is_enabled_monthly' => 'Monthly',
    'admin_settings.monitors_heartbeats.email_reports_is_enabled_help' => 'Enabling the email reports will give your users the ability to get email reports of their monitors/heartbeats.',
    'admin_settings.monitors_heartbeats.monitors_ping_method' => 'Uptime monitors ping method',
    'admin_settings.monitors_heartbeats.monitors_ping_method_help' => 'exec - fastest and most efficient way, requires access to exec() command.<br />fsockopen - alternative for when the exec() command is not allowed.',
    'admin_settings.monitors_heartbeats.monitors_ipv6_ping_is_enabled' => 'Uptime monitors IPv6 ping is enabled',
    'admin_settings.monitors_heartbeats.monitors_ipv6_ping_is_enabled_help' => 'This feature enables the ability to ping IPv6 servers. It only works if your host supports IPv6.',
    'admin_settings.monitors_heartbeats.user_agent' => 'Custom user agent',
    'admin_settings.monitors_heartbeats.user_agent_help' => 'The user agent that is used when check requests are sent. Leave empty for default.',
    'admin_settings.monitors_heartbeats.decimals' => 'Uptime / Response time decimals',
    'admin_settings.monitors_heartbeats.monitors_default_request_method' => 'Default request method for website monitors',
    'admin_settings.monitors_heartbeats.monitors_default_request_method_help' => 'HEAD is recommended for default faster processing, as it does not wait for the website content to be retrieved.',
    'admin_settings.monitors_heartbeats.monitors_double_check_is_enabled' => 'Double check a failed monitor',
    'admin_settings.monitors_heartbeats.monitors_double_check_is_enabled_help' => 'When a monitor fails, the system waits X seconds and sends another request to confirm whether it is down or a false-positive.',
    'admin_settings.monitors_heartbeats.monitors_double_check_wait' => 'Double check wait time',
    'admin_settings.monitors_heartbeats.monitors_double_check_wait_help' => 'How much to wait before sending another request to a failed monitor. Only applies when the above toggle is enabled.',
    'admin_settings.monitors_heartbeats.blacklisted_domains' => 'Blacklisted domains',
    'admin_settings.monitors_heartbeats.blacklisted_domains_help' => 'People will not be able to submit any URL domain that is included in this list. Comma separated values of domains.',
    ...
    'admin_statistics.monitors_logs.menu' => 'Uptime monitors checks',
    'admin_statistics.monitors_logs.header' => 'Uptime monitors checks',
    'admin_statistics.monitors_logs.chart' => 'Checks',

    'admin_statistics.dns_monitors_logs.menu' => 'DNS monitors changes',
    'admin_statistics.dns_monitors_logs.header' => 'DNS monitors changes',
    'admin_statistics.dns_monitors_logs.chart' => 'Changes',

    'admin_statistics.server_monitors_logs.menu' => 'Server monitors changes',
    'admin_statistics.server_monitors_logs.header' => 'Server monitors changes',
    'admin_statistics.server_monitors_logs.chart' => 'Logs',

    'admin_statistics.heartbeats_logs.menu' => 'Heartbeats checks',
    'admin_statistics.heartbeats_logs.header' => 'Heartbeats checks',
    'admin_statistics.heartbeats_logs.chart' => 'Runs',

    'admin_statistics.statistics.menu' => 'Status pages statistics',
    'admin_statistics.statistics.header' => 'Status pages statistics',
    ...
    'admin_status_pages.title' => 'Status pages',
    'admin_status_pages.header' => 'Status pages',
    'admin_status_pages.menu' => 'Status pages',


    'admin_status_pages.table.name' => 'Name',
    'admin_status_pages.table.pageviews' => 'Pageviews',
    ...
    'admin_monitors.title' => 'Uptime monitors',
    'admin_monitors.header' => 'Uptime monitors',
    'admin_monitors.menu' => 'Uptime monitors',
    'admin_monitors.table.monitor' => 'Uptime monitor',
    'admin_monitors.table.stats' => 'Stats',
    'admin_monitors.table.average_response_time' => '%s avg. response time',
    'admin_monitors.table.uptime' => '%s uptime',


    'admin_dns_monitors.title' => 'DNS monitors',
    'admin_dns_monitors.header' => 'DNS monitors',
    'admin_dns_monitors.menu' => 'DNS monitors',
    'admin_dns_monitors.table.monitor' => 'DNS monitor',
    'admin_dns_monitors.table.stats' => 'Stats',
    'admin_dns_monitors.table.total_checks' => '%s total checks',
    'admin_dns_monitors.table.total_changes' => '%s total changes',


    'admin_server_monitors.title' => 'Server monitors',
    'admin_server_monitors.header' => 'Server monitors',
    'admin_server_monitors.menu' => 'Server monitors',
    'admin_server_monitors.table.monitor' => 'Server monitor',
    'admin_server_monitors.table.stats' => 'Stats',
    'admin_server_monitors.table.total_logs' => '%s total logs',


    'admin_heartbeats.title' => 'Heartbeats',
    'admin_heartbeats.header' => 'Heartbeats',
    'admin_heartbeats.menu' => 'Heartbeats',
    'admin_heartbeats.table.name' => 'Name',
    'admin_heartbeats.table.stats' => 'Stats',
    'admin_heartbeats.table.uptime' => '%s uptime',


    'admin_domain_names.title' => 'Domain names',
    'admin_domain_names.header' => 'Domain names',
    'admin_domain_names.menu' => 'Domain names',

    'admin_domain_names.table.domain_name' => 'Domain name',
    'admin_domain_names.table.name' => 'Name',
    'admin_domain_names.table.target' => 'Domain name',
    ...
    'admin_ping_servers.breadcrumb' => 'Ping servers',
    'admin_ping_servers.title' => 'Ping servers',
    'admin_ping_servers.header' => 'Ping servers',
    'admin_ping_servers.menu' => 'Ping servers',

    'admin_ping_servers.table.ping_server' => 'Ping server',
    'admin_ping_servers.table.location' => 'Location',
    'admin_ping_servers.table.monitors' => 'Uptime monitors',

    'admin_ping_servers.main.name' => 'Name',
    'admin_ping_servers.main.url' => 'Ping server URL',
    'admin_ping_servers.main.url_placeholder' => 'https://domain.com/index.php',
    'admin_ping_servers.main.country_code_help' => 'The country of where the ping server is located.',
    'admin_ping_servers.main.city_name_help' => 'The name of the city of where the server is located.',
    'admin_ping_servers.error_message' => 'Ping server check error',
    'admin_ping_servers.success_message' => 'Ping server works as it returns expected results.',
    'admin_ping_servers.success_message2' => 'We sent a test ping to %s via %s and it returned: %s',


    'admin_ping_server_create.breadcrumb' => 'Add ping server',
    'admin_ping_server_create.title' => 'Add a new ping server',
    'admin_ping_server_create.header' => 'Add a new ping server',
    'admin_ping_server_create.subheader' => 'Make sure to properly read the <a href="https://altumco.de/66uptime-docs" target="_blank">Documentation</a> on how to setup new Ping Servers.',
    'admin_ping_server_create.menu' => 'Add ping server',


    'admin_ping_server_update.breadcrumb' => 'Edit ping server',
    'admin_ping_server_update.title' => 'Edit ping server',
    'admin_ping_server_update.header' => 'Edit ping server',
];
