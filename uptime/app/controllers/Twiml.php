...
class Twiml extends Controller {
    ...
    public function index() {
        ...
        $available_language_keys = [
            'heartbeat.simple_notification.is_ok',
            'heartbeat.simple_notification.is_not_ok',
            'domain_name.simple_notification.ssl',
            'domain_name.simple_notification.whois',
            'monitor.simple_notification.is_ok',
            'monitor.simple_notification.is_not_ok',
            'dns_monitor.simple_notification',
            'server_monitor.simple_notification.alert',
        ];
