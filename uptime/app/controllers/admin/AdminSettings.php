...
class AdminSettings extends Controller {
    ...
    public function ads() {
        ...
        if(!empty($_POST)) {
            ...
            $value = json_encode([
                ...
                'header' => $_POST['header'],
                'footer' => $_POST['footer'],
                'header_status_pages' => $_POST['header_status_pages'],
                'footer_status_pages' => $_POST['footer_status_pages'],
            ]);
    ...
    public function custom() {
        ...
        if(!empty($_POST)) {
            ...
            $value = json_encode([
                ...
                'head_js_status_page' => $_POST['head_js_status_page'],
                'head_css_status_page' => $_POST['head_css_status_page'],
                'body_content_status_page' => $_POST['body_content_status_page'],
            ]);
    ...
    public function status_pages() {
        ...
        if(!empty($_POST)) {
            ...
            $value = json_encode([
                'status_pages_is_enabled' => isset($_POST['status_pages_is_enabled']),
            ...
            $this->update_settings('status_pages', $value);
        }
    }

    public function monitors_heartbeats() {
        $this->process();
        ...
        if(!empty($_POST)) {
            ...
            $_POST['monitors_ping_method'] = in_array($_POST['monitors_ping_method'], ['exec', 'fsockopen']) ? $_POST['monitors_ping_method'] : 'exec';
            $_POST['monitors_default_request_method'] = in_array($_POST['monitors_default_request_method'], ['GET','POST','HEAD','OPTIONS','PUT','PATCH']) ? $_POST['monitors_default_request_method'] : 'HEAD';
            $_POST['user_agent'] = input_clean($_POST['user_agent']);
            $_POST['blacklisted_domains'] = array_filter(array_map('trim', explode(',', $_POST['blacklisted_domains'])));
            $_POST['projects_is_enabled'] = (int) isset($_POST['projects_is_enabled']);

            $value = json_encode([
                'monitors_is_enabled' => isset($_POST['monitors_is_enabled']),
                'dns_monitors_is_enabled' => isset($_POST['dns_monitors_is_enabled']),
                'server_monitors_is_enabled' => isset($_POST['server_monitors_is_enabled']),
                'heartbeats_is_enabled' => isset($_POST['heartbeats_is_enabled']),
                'domain_names_is_enabled' => isset($_POST['domain_names_is_enabled']),
                'email_reports_is_enabled' => $_POST['email_reports_is_enabled'],
                'monitors_ipv6_ping_is_enabled' => isset($_POST['monitors_ipv6_ping_is_enabled']),
                'monitors_ping_method' => $_POST['monitors_ping_method'],
                'monitors_default_request_method' => $_POST['monitors_default_request_method'],
                'monitors_double_check_is_enabled' => isset($_POST['monitors_double_check_is_enabled']),
                'monitors_double_check_wait' => (int) $_POST['monitors_double_check_wait'],
            ...
            $this->update_settings('monitors_heartbeats', $value);
        }
    }
