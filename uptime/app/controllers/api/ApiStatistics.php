...
class ApiStatistics extends Controller {
    ...
    private function get() {
        ...
        $this->status_page = $status_page = db()->where('status_page_id', $status_page_id)->where('user_id', $this->api_user->user_id)->getOne('status_pages');
            ...
            case 'overview':
                ...
                $result = database()->query("
                    ...
                    FROM
                         `statistics`
                    WHERE
                        `status_page_id` = {$this->status_page->status_page_id}
