...
class User extends Model {
    ...
    public function create(
        ...
        $preferences = json_encode([
            ...
            'monitors_default_order_by' => 'monitor_id',
            'dns_monitors_default_order_by' => 'dns_monitor_id',
            'heartbeats_default_order_by' => 'heartbeat_id',
            'server_monitors_default_order_by' => 'server_monitor_id',
            'domain_names_default_order_by' => 'domain_name_id',
            'status_pages_default_order_by' => 'status_page_id'
        ]);
