...
<div class="container">
    ...
    <?php elseif(is_numeric($data->plan_id)): ?>
        ...
        $annual_price_savings = number_format(($data->plan->prices->monthly->{currency()} * 12) - $data->plan->prices->annual->{currency()}, 2);
        ?>
                    ...
                    <div>
                        <div class="row d-flex align-items-stretch">
                            ...
                            <?php if($data->plan->prices->quarterly->{currency()}): ?>
                                <label class="col-12 p-2 custom-radio-box m-0">
                                    <input type="radio" id="quarterly_price" name="payment_frequency" value="quarterly" class="custom-control-input" required="required" <?= settings()->payment->default_payment_frequency == 'quarterly' ? 'checked="checked"' : null ?>>
                                    ...
                                    <div class="card">
                                        <div class="card-body d-flex align-items-center justify-content-between">
                                            ...
                                            <div>
                                                <div class="d-flex align-items-center">
                                                    <span id="quarterly_price_amount" class="custom-radio-box-main-text"><?= nr($data->plan->prices->quarterly->{currency()}, 2) ?></span>
                                                    <span class="ml-1"><?= currency() ?></span>
                                                </div>
                                            </div>
                            ...
                            <?php if($data->plan->prices->biannual->{currency()}): ?>
                                <label class="col-12 p-2 custom-radio-box m-0">
                                    <input type="radio" id="biannual_price" name="payment_frequency" value="biannual" class="custom-control-input" required="required" <?= settings()->payment->default_payment_frequency == 'biannual' ? 'checked="checked"' : null ?>>
                                    ...
                                    <div class="card">
                                        <div class="card-body d-flex align-items-center justify-content-between">
                                            ...
                                            <div>
                                                <div class="d-flex align-items-center">
                                                    <span id="biannual_price_amount" class="custom-radio-box-main-text"><?= nr($data->plan->prices->biannual->{currency()}, 2) ?></span>
                                                    <span class="ml-1"><?= currency() ?></span>
                                                </div>
                                            </div>
