    ...
    <div class="card-body">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div class="d-flex align-items-center">
                ...
                <div class="ml-2">
                    <span data-toggle="tooltip" title="<?= l('status_page_statistics.country_help') ?>">
                    ...
                    <div class="d-flex justify-content-between mb-1">
                        <div class="text-truncate">
                            ...
                            <?php if($row->country_code): ?>
                                <a href="<?= url('status-page-statistics/' . $data->status_page->status_page_id . '?type=city_name&country_code=' . $row->country_code . '&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" title="<?= $row->country_code ?>" class=""><?= get_country_from_country_code($row->country_code) ?></a>
                            <?php else: ?>
        ...
        new svgMap({
            ...
            data: {
                data: {
                    pageviews: {
                        name: '',
                        format: '{0} <?= l('status_page_statistics.pageviews') ?>',
