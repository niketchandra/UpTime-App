            ...
            <div class="card-body">
                <div class="row">
                    <div class="col text-truncate">
                        <small class="text-muted font-weight-bold"><?= l('admin_monitors.menu') ?></small>
                    </div>
                    <div class="col-auto">
                    <span class="p-2 bg-primary-100 rounded">
                        <i class="fas fa-fw fa-sm fa-server text-primary"></i>
                    </span>
                    </div>
                </div>
                <div class="mt-2 text-break">
                    <a href="<?= url('admin/monitors') ?>" class="stretched-link text-reset text-decoration-none">
                        <span class="h4"><?= nr($data->monitors) ?></span>
                    </a>
                    <div class="mt-1"><span class="small text-muted"><?= nr($data->monitors_current_month) ?> <?= mb_strtolower(l('global.date.this_month')) ?></span></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <div class="row">
                    <div class="col text-truncate">
                        <small class="text-muted font-weight-bold"><?= l('admin_heartbeats.menu') ?></small>
                    </div>
                    <div class="col-auto">
                    <span class="p-2 bg-primary-100 rounded">
                        <i class="fas fa-fw fa-sm fa-heartbeat text-primary"></i>
                    </span>
                    </div>
                </div>
                <div class="mt-2 text-break">
                    <a href="<?= url('admin/heartbeats') ?>" class="stretched-link text-reset text-decoration-none">
                        <span class="h4"><?= nr($data->heartbeats) ?></span>
                    </a>
                    <div class="mt-1"><span class="small text-muted"><?= nr($data->heartbeats_current_month) ?> <?= mb_strtolower(l('global.date.this_month')) ?></span></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <div class="row">
                    <div class="col text-truncate">
                        <small class="text-muted font-weight-bold"><?= l('admin_server_monitors.menu') ?></small>
                    </div>
                    <div class="col-auto">
                    <span class="p-2 bg-primary-100 rounded">
                        <i class="fas fa-fw fa-sm fa-microchip text-primary"></i>
                    </span>
                    </div>
                </div>
                <div class="mt-2 text-break">
                    <a href="<?= url('admin/server-monitors') ?>" class="stretched-link text-reset text-decoration-none">
                        <span class="h4"><?= nr($data->server_monitors) ?></span>
                    </a>
                    <div class="mt-1"><span class="small text-muted"><?= nr($data->server_monitors_current_month) ?> <?= mb_strtolower(l('global.date.this_month')) ?></span></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <div class="row">
                    <div class="col text-truncate">
                        <small class="text-muted font-weight-bold"><?= l('admin_status_pages.menu') ?></small>
                    </div>
                    <div class="col-auto">
                    <span class="p-2 bg-primary-100 rounded">
                ...
                <div class="mt-2 text-break">
                    <a href="<?= url('admin/status-pages') ?>" class="stretched-link text-reset text-decoration-none">
                        <span class="h4"><?= nr($data->status_pages) ?></span>
                    </a>
                    <div class="mt-1"><span class="small text-muted"><?= nr($data->status_pages_current_month) ?> <?= mb_strtolower(l('global.date.this_month')) ?></span></div>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card-body">
                ...
                <div class="mt-2 text-break">
                    <a href="<?= url('admin/domains') ?>" class="stretched-link text-reset text-decoration-none">
                        <span class="h4"><?= nr($data->domains) ?></span>
                    </a>
