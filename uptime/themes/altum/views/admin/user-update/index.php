        ...
        <form action="" method="post" role="form" enctype="multipart/form-data">
            ...
            <div id="plan_settings" style="display: none">
                ...
                <div class="form-group">
                    ...
                    <select id="monitors_ping_servers" name="monitors_ping_servers[]" class="custom-select" multiple="multiple">
                        <?php foreach((new \Altum\Models\PingServers())->get_ping_servers() as $ping_server): ?>
                            <option value="<?= $ping_server->ping_server_id ?>" <?= in_array($ping_server->ping_server_id, $data->user->plan_settings->monitors_ping_servers ?? [])  ? 'selected="selected"' : null ?>>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="dns_monitors_limit" name="dns_monitors_limit" min="-1" class="form-control" value="<?= $data->user->plan_settings->dns_monitors_limit ?>" />
                    <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="dns_monitors_check_intervals" name="dns_monitors_check_intervals[]" class="custom-select" multiple="multiple">
                        <?php foreach($data->dns_monitor_check_intervals as $key => $value): ?>
                            <option value="<?= $key ?>" <?= in_array($key, $data->user->plan_settings->dns_monitors_check_intervals ?? [])  ? 'selected="selected"' : null ?>>
                                <?= $value ?>
                            </option>
                        <?php endforeach ?>
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="server_monitors_limit" name="server_monitors_limit" min="-1" class="form-control" value="<?= $data->user->plan_settings->server_monitors_limit ?>" />
                    <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="server_monitors_check_intervals" name="server_monitors_check_intervals[]" class="custom-select" multiple="multiple">
                        <?php foreach($data->server_monitor_check_intervals as $key => $value): ?>
                            <option value="<?= $key ?>" <?= in_array($key, $data->user->plan_settings->server_monitors_check_intervals ?? [])  ? 'selected="selected"' : null ?>>
                                <?= $value ?>
                            </option>
                        <?php endforeach ?>
                    </select>
