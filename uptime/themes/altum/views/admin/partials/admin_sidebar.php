...
<section class="admin-sidebar">
    ...
    <div class="admin-sidebar-links-wrapper">
        <ul class="admin-sidebar-links">
            ...
            <li class="<?= in_array(\Altum\Router::$controller, ['AdminMonitors']) ? 'active' : null ?>">
                <a class="nav-link text-truncate" href="<?= url('admin/monitors') ?>">
                    <i class="fas fa-fw fa-sm fa-server mr-2"></i> <?= l('admin_monitors.menu') ?>
                </a>
            </li>

            <li class="<?= in_array(\Altum\Router::$controller, ['AdminDnsMonitors']) ? 'active' : null ?>">
                <a class="nav-link text-truncate" href="<?= url('admin/dns-monitors') ?>">
                    <i class="fas fa-fw fa-sm fa-plug mr-2"></i> <?= l('admin_dns_monitors.menu') ?>
                </a>
            </li>

            <li class="<?= in_array(\Altum\Router::$controller, ['AdminServerMonitors']) ? 'active' : null ?>">
                <a class="nav-link text-truncate" href="<?= url('admin/server-monitors') ?>">
                    <i class="fas fa-fw fa-sm fa-microchip mr-2"></i> <?= l('admin_server_monitors.menu') ?>
                </a>
            </li>

            <li class="<?= in_array(\Altum\Router::$controller, ['AdminHeartbeats']) ? 'active' : null ?>">
                <a class="nav-link text-truncate" href="<?= url('admin/heartbeats') ?>">
                    <i class="fas fa-fw fa-sm fa-heartbeat mr-2"></i> <?= l('admin_heartbeats.menu') ?>
                </a>
            </li>

            <li class="<?= in_array(\Altum\Router::$controller, ['AdminDomainNames']) ? 'active' : null ?>">
                <a class="nav-link text-truncate" href="<?= url('admin/domain-names') ?>">
                    <i class="fas fa-fw fa-sm fa-network-wired mr-2"></i> <?= l('admin_domain_names.menu') ?>
                </a>
            </li>

            <li class="<?= in_array(\Altum\Router::$controller, ['AdminStatusPages']) ? 'active' : null ?>">
                <a class="nav-link text-truncate" href="<?= url('admin/status-pages') ?>">
                    <i class="fas fa-fw fa-sm fa-wifi mr-2"></i> <?= l('admin_status_pages.menu') ?>
                </a>
            </li>
            ...
            <li class="<?= in_array(\Altum\Router::$controller, ['AdminPingServers', 'AdminPingServerCreate', 'AdminPingServerUpdate']) ? 'active' : null ?>">
                <a class="nav-link text-truncate" href="<?= url('admin/ping-servers') ?>">
                    <i class="fas fa-fw fa-sm fa-map-marked-alt mr-2"></i> <?= l('admin_ping_servers.menu') ?>
                </a>
            </li>
