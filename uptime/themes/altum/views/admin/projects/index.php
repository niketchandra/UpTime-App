                ...
                <tr>
                    ...
                    <td class="text-nowrap">
                        <div class="d-flex align-items-center">
                            <a href="<?= url('admin/monitors?project_id=' . $row->project_id) ?>" class="mr-2" data-toggle="tooltip" title="<?= l('admin_monitors.menu') ?>">
                                <i class="fas fa-fw fa-server text-muted"></i>
                            </a>

                            <a href="<?= url('admin/heartbeats?project_id=' . $row->project_id) ?>" class="mr-2" data-toggle="tooltip" title="<?= l('admin_heartbeats.menu') ?>">
                                <i class="fas fa-fw fa-heartbeat text-muted"></i>
                            </a>

                            <a href="<?= url('admin/status-pages?project_id=' . $row->project_id) ?>" class="mr-2" data-toggle="tooltip" title="<?= l('admin_status_pages.menu') ?>">
