...
<div class="d-flex flex-column flex-md-row justify-content-between mb-4">
    <h1 class="h3 mb-3 mb-md-0"><i class="fas fa-fw fa-xs fa-heartbeat text-primary-900 mr-2"></i> <?= l('admin_heartbeats.header') ?></h1>
        ...
        <div>
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right d-print-none">
                    <a href="<?= url('admin/heartbeats?' . $data->filters->get_get() . '&export=csv') ?>" target="_blank" class="dropdown-item <?= $this->user->plan_settings->export->csv ? null : 'disabled' ?>">
                        <i class="fas fa-fw fa-sm fa-file-csv mr-2"></i> <?= sprintf(l('global.export_to'), 'CSV') ?>
                    </a>
                    <a href="<?= url('admin/heartbeats?' . $data->filters->get_get() . '&export=json') ?>" target="_blank" class="dropdown-item <?= $this->user->plan_settings->export->json ? null : 'disabled' ?>">
                    ...
                    <form action="" method="get" role="form">
                        ...
                        <div class="form-group px-4">
                            ...
                            <select name="search_by" id="filters_search_by" class="custom-select custom-select-sm">
                                <option value="name" <?= $data->filters->search_by == 'name' ? 'selected="selected"' : null ?>><?= l('admin_heartbeats.table.name') ?></option>
                            </select>
                        </div>
                        ...
                        <div class="form-group px-4">
                            ...
                            <select name="order_by" id="filters_order_by" class="custom-select custom-select-sm">
                                ...
                                <option value="name" <?= $data->filters->order_by == 'name' ? 'selected="selected"' : null ?>><?= l('admin_heartbeats.table.name') ?></option>
...
<form id="table" action="<?= SITE_URL . 'admin/heartbeats/bulk' ?>" method="post" role="form">
    ...
    <table class="table table-custom">
        ...
        <tr>
            ...
            <th><?= l('global.user') ?></th>
            <th><?= l('admin_heartbeats.table.name') ?></th>
            <th><?= l('admin_heartbeats.table.stats') ?></th>
        ...
        <?php foreach($data->heartbeats as $row): ?>
            ...
            <tr>
                ...
                <td class="text-nowrap">
                    <span class="text-muted"><?= sprintf(l('admin_heartbeats.table.uptime'), nr($row->uptime, settings()->monitors_heartbeats->decimals) . '%') ?></span>
                </td>
                <td class="text-nowrap">
                ...
                <td>
                    <div class="d-flex justify-content-end">
                        <?= include_view(THEME_PATH . 'views/admin/heartbeats/admin_heartbeat_dropdown_button.php', ['id' => $row->heartbeat_id, 'resource_name' => $row->name]) ?>
                    </div>
                </td>
            </tr>
        <?php endforeach ?>
