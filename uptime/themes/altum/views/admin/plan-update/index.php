        ...
        <form action="" method="post" role="form">
            ...
            <div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="monitors_limit" name="monitors_limit" min="-1" class="form-control" value="<?= $data->plan->settings->monitors_limit ?>" />
                ...
                <div class="form-group">
                    ...
                    <select id="monitors_check_intervals" name="monitors_check_intervals[]" class="custom-select" multiple="multiple">
                        <?php foreach($data->monitor_check_intervals as $key => $value): ?>
                            <option value="<?= $key ?>" <?= in_array($key, $data->plan->settings->monitors_check_intervals ?? [])  ? 'selected="selected"' : null ?>>
                                <?= $value ?>
                            </option>
                        <?php endforeach ?>
                    </select>
                ...
                <div class="form-group">
                    <label for="monitors_ping_servers"><?= l('admin_plans.plan.monitors_ping_servers') ?></label>
                    <select id="monitors_ping_servers" name="monitors_ping_servers[]" class="custom-select" multiple="multiple">
                        <?php foreach((new \Altum\Models\PingServers())->get_ping_servers() as $ping_server): ?>
                            <option value="<?= $ping_server->ping_server_id ?>" <?= in_array($ping_server->ping_server_id, $data->plan->settings->monitors_ping_servers ?? [])  ? 'selected="selected"' : null ?>>
                                <?= $ping_server->name . ' - ' . get_countries_array()[$ping_server->country_code] . ' - ' . $ping_server->city_name ?>
                            </option>
                        <?php endforeach ?>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="heartbeats_limit" name="heartbeats_limit" min="-1" class="form-control" value="<?= $data->plan->settings->heartbeats_limit ?>" />
                    <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                </div>

                <div class="form-group">
                    <label for="domain_names_limit"><?= l('admin_plans.plan.domain_names_limit') ?></label>
                    <input type="number" id="domain_names_limit" name="domain_names_limit" min="-1" class="form-control" value="<?= $data->plan->settings->domain_names_limit ?>" />
                    <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                </div>

                <div class="form-group">
                    <label for="dns_monitors_limit"><?= l('admin_plans.plan.dns_monitors_limit') ?></label>
                    <input type="number" id="dns_monitors_limit" name="dns_monitors_limit" min="-1" class="form-control" value="<?= $data->plan->settings->dns_monitors_limit ?>" />
                    <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                </div>

                <div class="form-group">
                    <label for="dns_monitors_check_intervals"><?= l('admin_plans.plan.dns_monitors_check_intervals') ?></label>
                    <select id="dns_monitors_check_intervals" name="dns_monitors_check_intervals[]" class="custom-select" multiple="multiple">
                        <?php foreach($data->dns_monitor_check_intervals as $key => $value): ?>
                            <option value="<?= $key ?>" <?= in_array($key, $data->plan->settings->dns_monitors_check_intervals ?? [])  ? 'selected="selected"' : null ?>>
                                <?= $value ?>
                            </option>
                        <?php endforeach ?>
                    </select>
                ...
                <div class="form-group">
                    <label for="server_monitors_limit"><?= l('admin_plans.plan.server_monitors_limit') ?></label>
                    <input type="number" id="server_monitors_limit" name="server_monitors_limit" min="-1" class="form-control" value="<?= $data->plan->settings->server_monitors_limit ?>" />
                    <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                </div>

                <div class="form-group">
                    <label for="server_monitors_check_intervals"><?= l('admin_plans.plan.server_monitors_check_intervals') ?></label>
                    <select id="server_monitors_check_intervals" name="server_monitors_check_intervals[]" class="custom-select" multiple="multiple">
                        <?php foreach($data->server_monitor_check_intervals as $key => $value): ?>
                            <option value="<?= $key ?>" <?= in_array($key, $data->plan->settings->server_monitors_check_intervals ?? [])  ? 'selected="selected"' : null ?>>
                                <?= $value ?>
                            </option>
                        <?php endforeach ?>
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="status_pages_limit" name="status_pages_limit" min="-1" class="form-control" value="<?= $data->plan->settings->status_pages_limit ?>" />
                    <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="number" id="logs_retention" name="logs_retention" min="-1" class="form-control" value="<?= $data->plan->settings->logs_retention ?>" />
                        <div class="input-group-append">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="number" id="statistics_retention" name="statistics_retention" min="-1" class="form-control" value="<?= $data->plan->settings->statistics_retention ?>" />
                        <div class="input-group-append">
                            <span class="input-group-text"><?= l('global.date.days') ?></span>
                        </div>
                    </div>
