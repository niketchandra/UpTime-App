                            ...
                            <td class="text-nowrap">
                                <div class="d-flex align-items-center">
                                    <?php if(settings()->monitors_heartbeats->monitors_is_enabled): ?>
                                        <a href="<?= url('monitors?project_id=' . $row->project_id) ?>" class="mr-2" data-toggle="tooltip" title="<?= l('monitors.title') ?>">
                                            <i class="fas fa-fw fa-server text-muted"></i>
                                        </a>
                                    <?php endif ?>

                                    <?php if(settings()->monitors_heartbeats->heartbeats_is_enabled): ?>
                                        <a href="<?= url('heartbeats?project_id=' . $row->project_id) ?>" class="mr-2" data-toggle="tooltip" title="<?= l('heartbeats.title') ?>">
                                            <i class="fas fa-fw fa-heartbeat text-muted"></i>
                                        </a>
                                    <?php endif ?>

                                    <?php if(settings()->monitors_heartbeats->domain_names_is_enabled): ?>
                                        <a href="<?= url('domain-names?project_id=' . $row->project_id) ?>" class="mr-2" data-toggle="tooltip" title="<?= l('domain_names.title') ?>">
                                            <i class="fas fa-fw fa-network-wired text-muted"></i>
                                        </a>
                                    <?php endif ?>

                                    <?php if(settings()->monitors_heartbeats->dns_monitors_is_enabled): ?>
                                        <a href="<?= url('dns-monitors?project_id=' . $row->project_id) ?>" class="mr-2" data-toggle="tooltip" title="<?= l('dns_monitors.title') ?>">
                                            <i class="fas fa-fw fa-plug text-muted"></i>
                                        </a>
                                    <?php endif ?>

                                    <?php if(settings()->monitors_heartbeats->server_monitors_is_enabled): ?>
                                        <a href="<?= url('server-monitors?project_id=' . $row->project_id) ?>" class="mr-2" data-toggle="tooltip" title="<?= l('server_monitors.title') ?>">
                                            <i class="fas fa-fw fa-microchip text-muted"></i>
                                        </a>
                                    <?php endif ?>

                                    <?php if(settings()->status_pages->status_pages_is_enabled): ?>
                                        <a href="<?= url('status-pages?project_id=' . $row->project_id) ?>" class="mr-2" data-toggle="tooltip" title="<?= l('status_pages.title') ?>">
