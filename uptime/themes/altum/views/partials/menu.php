            ...
            <ul class="navbar-nav">
                            ...
                            <div class="d-flex flex-column flex-lg-row">
                                <div class="pr-lg-3">
                                    ...
                                    <?php if(settings()->monitors_heartbeats->monitors_is_enabled): ?>
                                        <a href="<?= url('monitors') ?>" class="dropdown-item"><i class="fas fa-fw fa-sm fa-server mr-2"></i> <?= l('monitors.menu') ?></a>
                                    <?php endif ?>

                                    <?php if(settings()->monitors_heartbeats->dns_monitors_is_enabled): ?>
                                        <a href="<?= url('dns-monitors') ?>" class="dropdown-item"><i class="fas fa-fw fa-sm fa-plug mr-2"></i> <?= l('dns_monitors.menu') ?></a>
                                    <?php endif ?>

                                    <?php if(settings()->monitors_heartbeats->server_monitors_is_enabled): ?>
                                        <a href="<?= url('server-monitors') ?>" class="dropdown-item"><i class="fas fa-fw fa-sm fa-microchip mr-2"></i> <?= l('server_monitors.menu') ?></a>
                                    <?php endif ?>

                                    <?php if(settings()->monitors_heartbeats->heartbeats_is_enabled): ?>
                                        <a href="<?= url('heartbeats') ?>" class="dropdown-item"><i class="fas fa-fw fa-sm fa-heartbeat mr-2"></i> <?= l('heartbeats.menu') ?></a>
                                    <?php endif ?>

                                    <?php if(settings()->monitors_heartbeats->domain_names_is_enabled): ?>
                                        <a href="<?= url('domain-names') ?>" class="dropdown-item"><i class="fas fa-fw fa-sm fa-network-wired mr-2"></i> <?= l('domain_names.menu') ?></a>
                                    <?php endif ?>

                                    <?php if(settings()->status_pages->status_pages_is_enabled): ?>
                                        <a href="<?= url('status-pages') ?>" class="dropdown-item"><i class="fas fa-fw fa-sm fa-wifi mr-2"></i> <?= l('status_pages.menu') ?></a>
                                    <?php endif ?>
                ...
                <?php else: ?>
                    ...
                    <?php if(settings()->users->register_is_enabled): ?>
                        <li class="nav-item d-flex align-items-center"><a class="btn btn-sm btn-primary" href="<?= url('register') ?>"><?= l('register.menu') ?> <i class="fas fa-fw fa-xs fa-arrow-right ml-1"></i></a></li>
                    <?php endif ?>
