        ...
        <div class="col-12 col-lg-6 col-xl-4 mb-4">
            <div class="card pricing-card h-100" style="<?= settings()->plan_free->color ? 'border-top-color: ' . settings()->plan_free->color : null ?>">
                <div class="card-body d-flex flex-column">
                    ...
                    <div class="mb-3">
                        <div class="font-weight-bold text-center py-2 bg-blue-50 text-blue-800 rounded"><?= settings()->plan_free->translations->{\Altum\Language::$name}->name ?: settings()->plan_free->name ?></div>
                    </div>
        ...
        >
            <div class="card pricing-card h-100" style="<?= $plan->color ? 'border-top-color: ' . $plan->color : null ?>">
                <div class="card-body d-flex flex-column">
                    ...
                    <div class="mb-3">
                        <div class="font-weight-bold text-center py-2 bg-blue-50 text-blue-800 rounded">
                            <?= $plan->translations->{\Altum\Language::$name}->name ?: $plan->name ?>
        ...
        <div class="col-12 col-lg-6 col-xl-4 mb-4">
            <div class="card pricing-card h-100" style="<?= settings()->plan_custom->color ? 'border-top-color: ' . settings()->plan_custom->color : null ?>">
                <div class="card-body d-flex flex-column">
                    ...
                    <div class="mb-3">
                        <div class="font-weight-bold text-center py-2 bg-blue-50 text-blue-800 rounded"><?= settings()->plan_custom->translations->{\Altum\Language::$name}->name ?: settings()->plan_custom->name ?></div>
                    </div>
