                        ...
                        <section id="requirements" style="display: none">
                            ...
                            <div class="table-responsive table-custom-container">
                                <table class="table table-custom">
                                    ...
                                    <tr>
                                        ...
                                        <td><?= PHP_VERSION ?></td>
                                        <td class="text-right">
                                            <?php if(version_compare(PHP_VERSION, '8.1.0', '>=') && version_compare(PHP_VERSION, '8.5', '<')): ?>
                                                ✅
                                            <?php else: ?>
                                                ❌
                            ...
                            <div class="table-responsive table-custom-container mt-5">
                                <table class="table table-custom">
                                    ...
                                    <tbody>
                                    <?php foreach(['config.php', 'uploads/main/', 'uploads/users/', 'uploads/cache/', 'uploads/cookie_consent', 'uploads/logs', 'uploads/offline_payment_proofs/', 'uploads/blog/', 'uploads/pwa/', 'uploads/dynamic_og_images/', 'uploads/status_pages_favicons/', 'uploads/status_pages_logos/', 'uploads/status_pages_opengraph/'] as $key): ?>
                                        <tr>
                                            <td>/<?= $key ?></td>
                        ...
                        <section id="setup" style="display: none">
                            ...
                            <form id="setup_form" method="post" action="" role="form">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="license_key" name="license_key" value="<?= defined('KEY') ? KEY : '' ?>" required="required" >
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="database_host" name="database_host" value="<?= defined('DATABASE_SERVER') ? DATABASE_SERVER : '' ?>" required="required">
                                </div>

                                <div class="form-group">
                                    <label for="database_name">Name</label>
                                    <input type="text" class="form-control" id="database_name" name="database_name" value="<?= defined('DATABASE_NAME') ? DATABASE_NAME : '' ?>" required="required">
                                </div>

                                <div class="form-group">
                                    <label for="database_username">Username</label>
                                    <input type="text" class="form-control" id="database_username" name="database_username" value="<?= defined('DATABASE_USERNAME') ? DATABASE_USERNAME : '' ?>" required="required">
                                </div>

                                <div class="form-group">
                                    <label for="database_password">Password</label>
                                    <input type="password" class="form-control" id="database_password" name="database_password" value="<?= defined('DATABASE_PASSWORD') ? DATABASE_PASSWORD : '' ?>">
                                </div>
